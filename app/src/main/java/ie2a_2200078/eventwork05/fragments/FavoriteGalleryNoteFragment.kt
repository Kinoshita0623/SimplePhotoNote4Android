...
class FavoriteGalleryNoteFragment : Fragment(R.layout.fragment_gallery_notes) {

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        val viewModel = ViewModelProvider(this, GalleryPostsViewModel.Factory(requireContext().applicationContext as MyApp, Mode.FAVORITE))[GalleryPostsViewModel::class.java]
